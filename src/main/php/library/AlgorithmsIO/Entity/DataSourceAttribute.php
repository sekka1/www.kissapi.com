 ...
 * DatSourceAttribs
 *
 * @ORM\Table(name="datasourceattribs")
 * @ORM\Entity
 */
require_once ("AlgorithmsIO/Entity/EntityAttributeBase.php");
class DataSourceAttribute extends EntityAttributeBase {
    ...
    /** @ORM\Id @ORM\ManyToOne(targetEntity="DataSources", inversedBy="attributes")
     */ // Removed (at)Id
