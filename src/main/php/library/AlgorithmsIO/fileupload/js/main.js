...
*/        
	    ...
	    beforeSend: function(xhr) {
            ...
            always: function (e, data) { console.log("DEBUG201208241644: Refreshing DataSource flexigrid"); $('#datasource_list').flexReload(); }, // Added to refresh the import_list showing the recently uploaded files - MRR20120529
